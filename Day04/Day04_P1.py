...
for i in range(len(elf_set_one_range_start)):
    if (list(set(range(int(elf_set_one_range_start[i]),int(elf_set_one_range_end[i])+1)).intersection(range(int(elf_set_two_range_start[i]),int(elf_set_two_range_end[i])+1))) == list(set(range(int(elf_set_one_range_start[i]),int(elf_set_one_range_end[i])+1)))) or (list(set(range(int(elf_set_one_range_start[i]),int(elf_set_one_range_end[i])+1)).intersection(range(int(elf_set_two_range_start[i]),int(elf_set_two_range_end[i])+1))) == list(set(range(int(elf_set_two_range_start[i]),int(elf_set_two_range_end[i])+1)))):
        sum = sum + 1
